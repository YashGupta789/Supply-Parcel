...
function preload(){
   ...
   dropPointIMG = loadImage("images/dropPoint.png");
   helicopter1 = loadAnimation("images/helicopter1.png");
   helicopter2 = loadAnimation("images/helicopter1.png","images/helicopter2.png","images/helicopter3.png","images/helicopter4.png");
}
...
function draw() {
  ...
  if(gameState === 1){
     ...
     button1.mousePressed(() => {
       helicopterSprite.x = helicopterSprite.x-35;
       helicopterSprite.addAnimation("helicopter",helicopter2);
     })
  ...
  if(gameState === 2){
      ...
      restart.position(400,480);
      restart.style('font-size','25px');
      restart.style('width', '180px');
      restart.style('height', '32px');
      restart.style('background', rgb(255, 185, 207));
